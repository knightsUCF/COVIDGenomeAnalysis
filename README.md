...
To get the indexes (locations) of where the start and stop codons occur in the COVID genomic sequence:
...
https://github.com/knightsUCF/COVIDGenomeAnalysis/blob/main/results/motif_x_research_team_results.txt
