...
"Motif X" is a special sequence of codons which exhibits mathematical properties. When detected this sequence seems to be used by biological mechanism to synchronize DNA / RNA. Work on Motif X has only been started and there is not a lot of research done yet in this field. 
