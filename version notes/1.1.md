...
When graphing the Biosum matrix mutations in COVID an interesting feature emerged -- there is a steep dropoff after the most frequent protein formula. And also the second most common protein formula variation has a relatively high Biosum index which could suggest that the most common COVID protein sequences prefer stable configurations.
