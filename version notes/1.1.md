...
- determine variations within each protein for every record
...
- use the Blosum matrix to determine how serious a mutation is

- complete version 1.1 with the tools necessary to set up a foundation for further protein region analysis in version 1.2
