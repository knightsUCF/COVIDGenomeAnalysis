...
Two main classes drive the tools for protein analysis, records.py and protein.py:
...
For a specific protein we can get the most common protein formulas ranked by frequency in the database. The specific ORF3a protein sequence at the end of the list has appeared nearly 20,000 times out of the entire available records at NCBI.
